      ...
      <div className="w-full max-w-[1240px] h-auto flex flex-col gap-[48px]">
        <div className="w-full h-auto flex flex-col lg:flex-row justify-between gap-8 lg:gap-[48px]">
          ...
          <div className="flex flex-col gap-[30px] w-full lg:w-[30%]">
            ...
            <ul className="text-[16px] font-medium text-black flex flex-col justify-between h-full gap-4">
              <li>Home</li>
              <li>Shop</li>
              <li>About</li>
              <li>Contact</li>
          ...
          <div className="flex flex-col gap-[30px] w-full lg:w-[30%] h-auto">
            <h2 className="text-[16px] font-medium text-[#9F9F9F]">Help</h2>
            <ul className="text-[16px] font-medium text-black h-full flex flex-col justify-between gap-4">
